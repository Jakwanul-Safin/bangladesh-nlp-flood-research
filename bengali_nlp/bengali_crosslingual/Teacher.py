...
class Teacher:
    def __init__(self, word2ind, aspect2ind, verbose=False,
                 tokenizer=None, stopwords=[]):
    ...
    def train(self, df, teacher_weight_dict=None, num_classes=2):
        ...
        for word, weight in teacher_weight_dict.items():
            ...
            #print(f"{word} has weight {weight}")
